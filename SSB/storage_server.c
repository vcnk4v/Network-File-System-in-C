...
#include "../defs.h"
#define CLIENT_PORT 5556 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dira2/file1");
    strcpy(accessiblePaths[1], "dirb2/file2");
    strcpy(accessiblePaths[2], "dirb2/file3");
    strcpy(accessiblePaths[3], "dirc2/file4");

...
#define CLIENT_PORT 5557 // Port for client connection
#include "../defs.h"
#define MYPATHS 4
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dira3/dirc3/dird3/file2");
    strcpy(accessiblePaths[1], "dira3/dirc3/file3");
    strcpy(accessiblePaths[2], "dira3/file1");
    strcpy(accessiblePaths[3], "dirb3/file4");

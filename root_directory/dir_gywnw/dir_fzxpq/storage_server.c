...
#include "../../../defs.h"
#define CLIENT_PORT 18201 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dir_rzuni/dir_eqfej/file_wux.txt");
    strcpy(accessiblePaths[1], "dir_rzuni/dir_aqmhk/");

...
#include "../../../../defs.h"
#define CLIENT_PORT 18208 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dir_juqnm/file_pzb.txt");
    strcpy(accessiblePaths[1], "dir_juqnm/file_veg.txt");
    strcpy(accessiblePaths[2], "dir_juqnm/file_veg.txt");
    strcpy(accessiblePaths[3], "dir_juqnm/file_vpx.txt");
    strcpy(accessiblePaths[4], "dir_juqnm/big_dir_test/big_file_70MB.txt");
    strcpy(accessiblePaths[5], "dir_juqnm/big_dir_test/med_file_10MB.txt");
    strcpy(accessiblePaths[6], "dir_juqnm/big_dir_test/med_file_15MB.txt");

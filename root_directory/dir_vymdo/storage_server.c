...
#include "../../defs.h"
#define CLIENT_PORT 18205 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dir_pfaau/dir_cscou/dir_mbbdr/file_mpe.txt");
    strcpy(accessiblePaths[1], "dir_pfaau/dir_cscou/dir_rjmdf/file_kdx.txt");
    strcpy(accessiblePaths[2], "dir_pfaau/dir_fpkwl/dir_cgpqn/");
    strcpy(accessiblePaths[3], "dir_pfaau/dir_fpkwl/dir_gxueg/");
    strcpy(accessiblePaths[4], "dir_picqp/dir_odqtp/");
    strcpy(accessiblePaths[5], "dir_picqp/dir_picaz/dir_cdsdh/file_dar.txt");
    strcpy(accessiblePaths[6], "dir_picqp/dir_picaz/dir_cdsdh/file_yyj.txt");
    strcpy(accessiblePaths[7], "dir_picqp/dir_picaz/dir_zdoid/");
    strcpy(accessiblePaths[8], "dir_picqp/dir_picaz/dir_tnaqz/file_kox.txt");

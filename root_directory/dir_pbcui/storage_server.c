...
#include "../../defs.h"
#define CLIENT_PORT 18200 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dir_bzaca/file_ofr.txt");
    strcpy(accessiblePaths[1], "dir_bzaca/file_qsw.txt");
    strcpy(accessiblePaths[2], "dir_bzaca/file_uag.txt");
    strcpy(accessiblePaths[3], "dir_bzaca/dir_ccftl/dir_hbsfj/");
    strcpy(accessiblePaths[4], "dir_qkdez/dir_htcrv/dir_mrrcz/file_imz.txt");

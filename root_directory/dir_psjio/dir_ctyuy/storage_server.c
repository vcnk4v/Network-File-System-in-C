...
#include "../../../defs.h"
#define CLIENT_PORT 18203 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dir_bqays/dir_adecw/file_qdh.txt");
    strcpy(accessiblePaths[1], "dir_bqays/dir_hlxuh/file_xmu.txt");
    strcpy(accessiblePaths[2], "dir_bqays/dir_hlxuh/file_rwf.txt");
    strcpy(accessiblePaths[3], "dir_bqays/dir_hlxuh/file_zsb.txt");

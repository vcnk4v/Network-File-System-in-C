...
#include "../defs.h"
#define CLIENT_PORT 5558 // Port for client connection
...
void initializeAccessiblePaths()
{
    ...
    strcpy(accessiblePaths[0], "dira4/file1");
    strcpy(accessiblePaths[1], "dirb4/dirc4/file2");
    strcpy(accessiblePaths[2], "dirb4/file3");
